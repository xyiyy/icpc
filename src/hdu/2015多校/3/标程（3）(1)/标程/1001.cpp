...
Data operator+(const Data &a, const Data &b) {
    Data ret;
    ret.s01 = max(a.s00 + b.s11, a.s01 + b.s01);
    checkmax(ret.s01, a.s01);
    checkmax(ret.s01, b.s01);
    ret.s00 = max(a.s00 + b.s10, a.s01 + b.s00);
    checkmax(ret.s00, a.s00);
    checkmax(ret.s00, b.s00);
    ret.s10 = max(a.s10 + b.s10, a.s11 + b.s00);
    checkmax(ret.s10, a.s10);
    checkmax(ret.s10, b.s10);
    ret.s11 = max(a.s10 + b.s11, a.s11 + b.s01);
    checkmax(ret.s11, a.s11);
    checkmax(ret.s11, b.s11);
    return ret;
}
